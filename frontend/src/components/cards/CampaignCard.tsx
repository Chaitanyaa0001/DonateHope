    ...
    <div className="dark:bg-[#0d0b1d] rounded-2xl border-2 overflow-hidden  border-[#C800DE] hover:shadow-lg transition duration-300 flex flex-col">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow">
        ...
        <div className="text-sm text-white mb-1">
          <span className="text-green-400 font-semibold">{card.raised} raised</span> <span className='text-black font-semibold dark:text-white' ><span className='text-black font-semibold dark:text-white'>of</span> {card.goal}</span>
        </div>
